...
function setup(){
    ...
    particle4 = Bodies.circle(230,10,10,block_options);
    World.add(world,particle4);
    particle5 =Bodies.circle(230,10,10,block_options);
    ...
    block1 = Bodies.rectangle(block1.position.x,block1.position.y,150,20,plane_options);
    World.add(world,block1);

    block2 = Bodies.rectangle(block2.position.x,block2.position.y,150,20,plane_options)
    World.add(world,block2);
